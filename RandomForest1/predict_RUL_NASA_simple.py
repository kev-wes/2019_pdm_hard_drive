...
from RandomForest1 import utils
import os
...
# Create cutoff times
# For each engine, a specific time is sampled and the cycles until it ends / RUL are calculated,
# i.e. the last time_in_cycles - the sampled time_in_cycles
# The model should calculate the RUL with only data up to the cutoff point
# The RUL is the new label for training
